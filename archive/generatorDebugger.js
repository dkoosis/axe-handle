...
const templateManager_1 = require("../src/utils/templateManager");
...
async function debugStepByStep() {
    ...
    try {
        ...
        for (const template of essentialTemplates) {
            const templatePath = path_1.default.join(templatesDir, template.framework, `${template.category}/${template.name}.eta`);
            try {
